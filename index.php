...
<!--
			...
			<b>
  			<div class="innerIam">
    			Art Director &nbsp <span class="pln"> I </span>  &nbsp Designer </span><br /> 
    			Reklame &nbsp <span class="pln"> I </span>  &nbsp Web </span><br /> 
    			Animasjon &nbsp <span class="pln"> I </span>  &nbsp foto </span><br />
		...
		-->
			...
			<a class="btn2" a href="#tilprosjekterdelen" onclick="smoothScroll('tilprosjekterdelen')">
    	    	<span class="row1"><h2>Mine arbeider</h2></span>
	        	<span class="row3"><h2>Se</h2></span>
      		
      		

      		<a class="btn" href="ommeg">
    	    	<span class="row1"><h2>Om meg</h2></span>
	        	<span class="row2"><h2>Les</h2></span>
      		</a>

      		<p id="safari"> ! For å spille av filmen i bakgrunnen, bytt til Chrome/Firefox for en bedre opplevelse av siden :-)</p>
      		
	</div>	


	<div class="fullscreen-bg">
    <video muted playsinline loop autoplay  poster="img/Main/OH-showreel-poster.png" class="fullscreen-bg__video">
        <source src="img/Main/OH_showreel_stor.mp4" type="video/webm">
    </video>
</div>


	<div class="bakgrunnsfoto"></div>
	...
	<div class="ikoner">
		...
		<a href="https://www.facebook.com/ole.kveseth" target="_blank" 
		div class="fbcircle">
	...
	<!--
	<video poster="img/Poster_film.jpg" playsinline autoplay muted loop>
		<source src="img/Bakgrunnsfilm.mp4"" type="video/mp4">
		</video>
	-->
...
<div class="prosjektwrapper">
	...
	<a href="/prosjekter/imdi"><div class="prosjekt2">
	...
	<a href="/prosjekter/113appen"><div class="prosjekt2">
	...
	<a href="/prosjekter/Flytoget2"><div class="prosjekt2">
	...
	<a href="/prosjekter/Norwegian"><div class="prosjekt2">
	...
	<a href="/prosjekter/Statensvegvesen"><div class="prosjekt2">
	...
	<a href="/prosjekter/Smartidrettsmat"><div class="prosjekt2">
		...
		<div class="tekstwrapper">
						...
						<h5>Smart Idrettsmat</h5>
					
			
				</div>
			<div class="sortoverlay"></div>
				<img id="thumb" src="../img/Smartidrettsmat/TineSI_Mockup_Film_Planlegger_thumb.jpg" alt="Bilde fra Smart Idrettsmat">
	</a>
	</div>
	...
	<a href="/prosjekter/Bouvetgrandprix.php"><div class="prosjekt2">
	...
	<a href="/prosjekter/Ruter"><div class="prosjekt2">
	...
	<a href="/prosjekter/Flyttutavbyen"><div class="prosjekt2">

		<div class="tekstwrapper">

						<h4>Block Watne</h4>

						<h5>Flytt ut av byen</h5>
	...
	<a href="/prosjekter/Millum"><div class="prosjekt2">
	...
	<a href="/prosjekter/Sparebank1"><div class="prosjekt2">

		<div class="tekstwrapper">

						<h4>Sparebank1</h4>
				
						<h5>Film & aktivitet</h5>
			...
			<a href="/prosjekter/obos"><div class="prosjekt2">
		...
		<a href="/prosjekter/Nordea"><div class="prosjekt2">
	...
	<a href="/prosjekter/Bouvetfilmen.php"><div class="prosjekt2">
	...
	<a href="/prosjekter/Kreftforeningen"><div class="prosjekt2">

		<div class="tekstwrapper">

						<h4>Kreftforeningen</h4>

						<h5>Stjerner gir håp</h5>
	...
	<a href="/prosjekter/Studentarbeider"><div class="prosjekt2">
		...
		<div class="tekstwrapper">
			...
			<div class="sortoverlay"></div>
			<img id="thumb" src="../img/Studentarbeider/Ikea_stolleken_forsidebilde_small.jpg" alt="Bilde fra Studentarbeider">
		</a>
	</div>
	...
	<a href="/prosjekter/Photoshoping"><div class="prosjekt2">
		...
		<div class="tekstwrapper">
			...
			<div class="sortoverlay"></div>
				<img id="thumb" src="../img/Photoshoping/Nike_Halloween_newedition_retusj_8.jpg" alt="Bilde fra Photoshopping">
...
<div class="bunnen">
	...
	<div class="bunntekst"><h3>Ole Hallvard Kveseth<h3></div>
