...
<div class="velkommen">
			...
			<img class="forsidebilde-mobil" src="../img/Bouvetgrandprix/BGP_Toppbilde_mobil.jpg" alt="Bouvet Grand Prix forsidebilde">

			<img class="forsidebilde-desktop-m" src="../img/Bouvetgrandprix/BGP_Toppbilde.jpg" alt="Bouvet Grand Prix forsidebilde">

			<img class="forsidebilde-desktop-l" src="../img/Bouvetgrandprix/BGP_Toppbilde.jpg" alt="Bouvet Grand Prix forsidebilde">
...
– på en avhengighetsskapende måte.
  ...
  <div class="video-wrapper">
    <div class="video-container-breddeformat"> <!-- Breddeformat -->
      <iframe src="https://player.vimeo.com/video/225247842" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
    </div>
  </div>
	...
	<p>Det gjelder å utnytte de muligheter som byr seg, og vi valgte derfor også å kombinere ”flyttemeldingen” med en leken invitasjon til den aller første kundefesten i våre nye
lokaler. I praksis betydde dette en e-post med en festinvitasjon – og med en mulighet til å råkjøre veien fra våre gamle lokaler til de nye i et egenutviklet bilspill. Spillet var basert på basert på Google/MapBox veivisningstjeneste, og kom du høyt nok på
high score-listen vanket det også premie på festen som beste sjåfør. Se hvor raskt du selv kan kjøre til kontoret vårt! Spill <a href="http://grandprix.bouvet.no" target="_blank">her</a> eller skriv inn grandprix.bouvet.no</p>
...
<p><br><b>Andre bidragsytere:</b><br><b>Utvkler</b>: Zulfeekar "Zulu" Cheriyampurath
<br><b>Utvikler:</b> Kristian Wille</p>
 ...
 <a href="/prosjekter/Smartidrettsmat.php"> <div class="circle c2 revealer">
  	<div class="container container--circles">
 		 <div class="circle c1 revealer">
			...
			<img id="thumb" src="../img/Smartidrettsmat/Tine_SI_Forsidebilde_Thumb.jpg" alt="Tine bilde">
  ...
  <a href="/prosjekter/Ruter.php"> <div class="circle c2 revealer">
  	<div class="container container--circles">
 		 <div class="circle c1 revealer">
   			<div class="circle__inner">
