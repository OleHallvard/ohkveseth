...
<head>
    <title>Referanseside I Smart Idrettsmat</title>

    <meta charset="UTF-8">
    <link rel="stylesheet" href="../css/referanseside.css">
    <link rel="stylesheet" href="../css/footerogheader.css">
    ...
    <script src="/bouvet-referanser/js/change.js"></script>
    <script src="/bouvet-referanser/js/toggle.js"></script>
    <script src="/bouvet-referanser/js/toggle_visibility.js"></script>
