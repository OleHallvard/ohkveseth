...
<div class="velkommen">
			...
			<img class="forsidebilde-mobil" src="../img/Millum/Millum_forsidebilde_mobil.jpg" alt="Forsidebilde Millum">

			<img class="forsidebilde-desktop-m" src="../img/Millum/Millum_forsidebilde_medium.jpg" alt="Forsidebilde Millum">

			<img class="forsidebilde-desktop-l" src="../img/Millum/Millum_forsidebilde_stor.jpg" alt="Forsidebilde Millum">
	
		

			<div class="tekstwrapper">

					<h4 class="reveal-text">Millum</h4>
		
					<h5 class="reveal-text2">Filmer om Millum</h5>
			</div>
...
<div class="prosjektwrapper">
		...
		Vi har laget en serie av filmer om de ulike produktene, her kan du se to av dem. <p>
  ...
  <div id="kvadratiskfilm" class="video-wrapper">
  ...
  <div id="kvadratiskfilm" class="video-wrapper">
    <div class="video-container-kvadratisk"> <!--Kvadratisk-->
      <iframe src="https://player.vimeo.com/video/275492462" width="640" height="640" frameborder="0"  mozallowfullscreen allowfullscreen></iframe>
...
<div class="film-container">
  ...
  <div id="kvadratiskfilm" class="video-wrapper">
    <div class="video-container-kvadratisk"> <!--Kvadratisk-->
      <iframe src="https://player.vimeo.com/video/294945526" width="640" height="640" frameborder="0"  mozallowfullscreen allowfullscreen></iframe>
		...
		<center><p><b>Et knippe av illustrasjonene som er laget til filmene:</b></center></p>
		
		<img class="prosjektbilde2" src="/img/Millum/Millum_Arbeidere2.jpg"/>
		<img class="prosjektbilde2" src="/img/Millum/Millum_Handshake.jpg"/>
		<img class="prosjektbilde2" src="/img/Millum/Millum_lastebil.jpg"/>
		<img class="prosjektbilde2" src="/img/Millum/Millum_Uniformer.jpg"/>
		
		
	
		<div class="ingress"><p><br><b>Andre bidragsytere:</b><br>Ole-Henrik Larssen<br>Astrid Storkås</b><br>Linda Sunde<br></p></div>
...
<div class="nesteprosjektwrapper">
  ...
  <a href="/prosjekter/flyttutavbyen.php"> <div class="circle c2 revealer">
  ...
  <a href="/prosjekter/Sparebank1.php"> <div class="circle c2 revealer">
  	<div class="container container--circles">
 		 <div class="circle c1 revealer">
   			<div class="circle__inner">
			...
			<div class="tekstwrapper">
				...
				<h6 class="reveal-text3">Sparebank 1</h6>
			
			</div>
			
			<div class="sortoverlay3"></div>
			<img id="thumb" src="../img/Sparebank1/Sparebank1.jpg" alt="Sparebank1">
